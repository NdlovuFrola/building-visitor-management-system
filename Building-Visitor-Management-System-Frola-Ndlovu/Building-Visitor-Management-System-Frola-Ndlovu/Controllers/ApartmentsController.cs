...
namespace Building_Visitor_Management_System_Frola_Ndlovu.Controllers
{
    public class ApartmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,ApartmentNumber")] Apartment apartment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,ApartmentNumber")] Apartment apartment)
        {
            if (ModelState.IsValid)
            {
